...
import { Brain, Sparkles, Clipboard} from "lucide-react";
...
export default function AIAssistant() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-neutral-50 to-pink-50">
      {/* Header */}
      <motion.div
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-neutral-900"> Medical Report Generation</h1>
              <p className="text-neutral-600">Generate custom marco-level patient analysis reports</p>
            </div>
            <div className="ml-auto">
              <div className="flex items-center gap-2 bg-gradient-to-r from-purple-100 to-blue-100 px-3 py-1 rounded-full">
                <Sparkles className="w-4 h-4 text-red-600" />
                <span className="text-sm font-medium text-red-700">RAG + Vector Search</span>
              </div>
            </div>
          </div>
        </div>
