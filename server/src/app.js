...
const visitRouter = require("./routes/visit_routes"); 
const checkupRouter = require("./routes/checkup_route"); 
const aiReportRoute = require('./routes/ai_report_routes');
const { speechRoutes } = require('./speech-processing');
const notFound = require('./middleware/notFound');
const errorHandler = require('./middleware/errorHandler');
const legacyVisitsBlocker = require("./routes/legacy_visit_blocker");
